    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        try{
            ...
            if(adminName.equals("") || adminMail.equals("") || adminPass.equals("")) {
                JOptionPane.showMessageDialog(null, "Cannot Insert empty values.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            } else {
                String sql = "INSERT INTO ADMIN (name, email, password) VALUES ('"+adminName+"', '"+adminMail+"', '"+adminPass+"')";
                stmt.execute(sql);

                JOptionPane.showMessageDialog(null, "New admin account created Successfully.", "Query Success", JOptionPane.INFORMATION_MESSAGE);
        }
