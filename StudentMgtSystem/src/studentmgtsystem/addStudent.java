...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            if(stuName.equals("") || gender.equals("") || stuGuardianName.equals("") || stuClass.equals("") || city.equals("")) {
                JOptionPane.showMessageDialog(null, "Cannot Insert empty values.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            } else {
                String sql = "INSERT INTO STUDENT(stuName, gender, stuFatherName, stuClass, blood, city, contactNumber) VALUES('"+stuName+"' , '"+gender+"', '"+stuGuardianName+"', '"+stuClass+"', '"+blood+"', '"+city+"', '"+contactNumber+"') ";
                stmt.execute(sql);

                JOptionPane.showMessageDialog(null, "New student account created Successfully.", "Query Success", JOptionPane.INFORMATION_MESSAGE);
        } 
